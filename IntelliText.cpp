...
// IntelliText.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CIntelliTextApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CIntelliTextApp::OnAppAbout)
...
// CIntelliTextApp construction

CIntelliTextApp::CIntelliTextApp() noexcept : m_pInstanceChecker(_T("IntelliText"))
{
	...
	SetAppID(_T("IntelliText.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CIntelliTextApp object

CIntelliTextApp theApp;

// CIntelliTextApp initialization

BOOL CIntelliTextApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_IntelliTextTYPE,
		RUNTIME_CLASS(CIntelliTextDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CIntelliTextView));
	if (!pDocTemplate)
		return FALSE;
...
int CIntelliTextApp::ExitInstance()
{
...
// CIntelliTextApp message handlers
...
BOOL CAboutDlg::OnInitDialog()
{
	...
	m_ctrlContributors.SetHyperlink(_T("https://github.com/mihaimoga/IntelliText/graphs/contributors"));
...
void CIntelliTextApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CIntelliTextApp customization load/save methods

void CIntelliTextApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CIntelliTextApp::LoadCustomState()
{
}

void CIntelliTextApp::SaveCustomState()
{
}
