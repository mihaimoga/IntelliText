...
// IntelliTextDoc.h : interface of the CIntelliTextDoc class
//

#pragma once

class CIntelliTextDoc : public CDocument
{
protected: // create from serialization only
	CIntelliTextDoc() noexcept;
	DECLARE_DYNCREATE(CIntelliTextDoc)
